...
public final class GameLocation implements ConfigurationSerializable {
    ...
    public Location toBukkitLocation(GameInstance instance) {
        return new Location(instance.getMap().getBukkitWorld(), x,y,z,yaw,pitch);
    }
    ...
    public static GameLocation deserialize(Map<String, Object> objectMap){
